...
export default function CRMChat({token}) {
  ...
  const STYLES = `
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .sb{width:36px;height:36px;border-radius:50%;border:none;cursor:pointer;transition:background .2s;display:flex;align-items:center;justify-content:center;font-size:16px;flex-shrink:0}
    ...
    .mi{padding:8px 12px;cursor:pointer;display:flex;align-items:center;gap:10px;font-size:13px;transition:background .1s;color:#f0e6ff}
    .mi:hover{background:#2d1155}
    .reacts{display:flex;gap:4px;flex-wrap:wrap;margin-bottom:3px}
    .msgs::-webkit-scrollbar{width:4px}
    .msgs::-webkit-scrollbar-track{background:transparent}
    .msgs::-webkit-scrollbar-thumb{background:#2d1155;border-radius:2px}
    @keyframes spin{to{transform:rotate(360deg)}}
    @keyframes pulse{0%,100%{opacity:.4}50%{opacity:.8}}
    @media(max-width:768px){.crm-root{grid-template-columns:40px 1fr}.rc{display:none}}
  `
