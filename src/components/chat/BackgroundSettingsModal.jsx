...
const BACKGROUND_OPTIONS = [
  ...
  { name: 'Real Madrid Classic', color: '#090e17', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/800px-Real_Madrid_CF.svg.png") center/35% no-repeat, url("https://images.unsplash.com/photo-1522778119026-d647f0596c20?auto=format&fit=crop&q=80&w=1920") center/cover', extraStyle: { backgroundBlendMode: 'screen' } },
  { name: 'Bernabéu Night', color: '#090e17', image: 'url("https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Santiago_Bernabeu_Stadium_-_Madrid.jpg/1200px-Santiago_Bernabeu_Stadium_-_Madrid.jpg") center/cover' },
  { name: 'Starting XI', color: '#111827', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center/15% no-repeat, url("https://images.unsplash.com/photo-1589487391730-58f20eb2c308?auto=format&fit=crop&q=80&w=1920") center/cover' },
  { name: 'Squad Lineup', color: '#111827', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center 15%/15% no-repeat, url("https://images.unsplash.com/photo-1518605368461-1e12c1c6888c?auto=format&fit=crop&q=80&w=1920") center/cover' },
  { name: 'Matchday', color: '#000', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center/20% no-repeat, url("https://images.unsplash.com/photo-1574629810360-7efbb1925536?auto=format&fit=crop&q=80&w=1920") center/cover', extraStyle: { backgroundBlendMode: 'overlay' } },
  { name: 'Champions Celebration', color: '#111827', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center 30%/20% no-repeat, url("https://images.unsplash.com/photo-1563823251940-272cb2500d02?auto=format&fit=crop&q=80&w=1920") center/cover' },
  { name: 'Tactical Board', color: '#2f4f4f', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center/20% no-repeat, url("https://images.unsplash.com/photo-1504450758481-7338eba7524a?auto=format&fit=crop&q=80&w=1920") center/cover' },
  { name: 'White Kits', color: '#f8fafc', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center/15% no-repeat, url("https://images.unsplash.com/photo-1551280857-2b9ebf241ac7?auto=format&fit=crop&q=80&w=1920") center/cover' },
  { name: 'UCL Night', color: '#020024', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/400px-Real_Madrid_CF.svg.png") center/25% no-repeat, url("https://images.unsplash.com/photo-1556056504-5c7696c4c28d?auto=format&fit=crop&q=80&w=1920") center/cover', extraStyle: { backgroundBlendMode: 'hard-light' } },
  { name: 'Hala Madrid', color: '#00529F', image: 'url("https://upload.wikimedia.org/wikipedia/en/thumb/5/56/Real_Madrid_CF.svg/800px-Real_Madrid_CF.svg.png") center/25% no-repeat, linear-gradient(135deg, #00529F, #111)' },
